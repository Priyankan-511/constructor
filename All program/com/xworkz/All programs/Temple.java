...
public class Temple {
	...
	public Temple(String name,String location,int open) {
		this(name,location);
		this.open=open;
		System.out.println("name location open are arg constructor");
	}
	public Temple(String name,String location,int open,int close) {
		this (name,location,open);
		this.close=close;
		System.out.println("name location open close are arg constructor");
	}
	public Temple(String name,String location,int open,int close,String openfulltime) {
